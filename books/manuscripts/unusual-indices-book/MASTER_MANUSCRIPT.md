...
The economy is too large to see.

That is the first problem. It is not hidden in the cinematic sense. It does not sit behind a locked door, waiting for one brave analyst with a torch. It is everywhere at once: in a shipping rate, a wage slip, a supermarket shelf, a mortgage payment, a lipstick counter, a container port, a polluted street, a benchmark leaderboard. It is too distributed, too abstract, too full of moving parts. People cannot hold it in their heads.

So they translate it.

They turn exchange rates into burgers. They turn purchasing power into hours of work. They turn recession anxiety into lipstick and underwear. They turn invisible particles in the air into cigarettes. They turn machine intelligence into leaderboard scores. Sometimes the translation is brilliant. Sometimes it is nonsense wearing a clever hat. Often it is both, which is why it survives.

An official statistic can be more accurate and less useful at the same time. A consumer price index may be methodologically serious, but nobody feels one in the hand. A Big Mac is not a national accounts system, but it is a thing a person can imagine buying. A ship carrying iron ore is not the whole global economy, but a dry bulk freight rate can say something real about physical demand. A benchmark for software-fixing AI does not tell us whether a machine is intelligent in any satisfying philosophical sense, but it does tell us whether a model can survive a very specific kind of practical test.

This book is about those translations.

It is not a catalogue of quirky indicators. A catalogue would be easy and dreadful: one index per page, a little anecdote, a neat moral, repeat until everyone involved loses the will to live. The useful question is not “How many weird indices exist?” The useful question is: why do some strange measures clarify the world while others become attractive folklore?

The answer is not simply accuracy. Accuracy matters, obviously. But strange indicators succeed because they compress. They take a system that feels remote and give it a handle. A burger becomes a currency argument. A phone becomes a wage argument. Lipstick becomes a recession story. Cigarettes become a pollution analogy. The handle is powerful because it is familiar. It is dangerous for exactly the same reason.

The human mind likes a good proxy. It likes one object standing in for a system, one vivid unit replacing an abstraction, one ranking telling us where we are. This habit is not stupid. It is how we navigate a world too complicated for direct perception. The problem begins when the proxy stops being a translation and starts pretending to be the thing itself.

A good strange indicator says: this is a useful way to look.

A bad one says: this is reality.

That difference is the book.

There is a second difference running underneath it: measurement and meaning are not the same thing.

A measurement can be technically correct and still fail to mean much to a human being. A price index can be serious and leave the reader unmoved. A benchmark can be well designed and still be misread by everyone quoting it. A ranking can compress reality efficiently and then be used as if it were reality. Numbers do not become meaningful merely by being numbers. They become meaningful when they connect to a question people understand.

This is why strange indicators are worth studying rather than merely collecting. They reveal the negotiation between technical measurement and human attention. They show how a unit can carry emotion, memory, bias, status and comedy. They show why a rough proxy may change public understanding faster than a perfect table. They also show why people who communicate data need more than accuracy. They need judgment about what the reader will do with the number once it lands.
...
The distinction matters because suspicion can become as stupid as credulity. There is a type of reader who thinks every popular comparison is fake because it simplifies. That reader is not being rigorous; they are often hiding from communication. All explanation simplifies. The question is whether the simplification is honest about what it loses.
...
This is not because McDonald’s is economically pure. Quite the opposite. A Big Mac is full of local contamination: rents, wages, advertising costs, supply chains, taxes, market strategy and the strange social role of eating American fast food in a given city. That contamination is the point. The burger is not a laboratory object. It is a small commercial animal living in the real world.
...
Many indicators in the book will fail one of those tests. The burger mostly passes.

And once you accept that a burger can translate money, the next question is obvious.

Why stop at money?

If prices are supposed to tell us what things cost, perhaps they are using the wrong unit. A price in dollars, euros or pesos is only half a sentence. The other half is the life required to earn it.

---

## Chapter 2 — Prices Become Human

A thousand-dollar phone is not the same object everywhere.

Physically, it may be close enough. Same glass, same camera bump, same small ritual of pretending you will not drop it. Economically, it can be several different creatures. In one country it is a mildly painful purchase. In another, it is a month of life. In a third, it is a luxury artifact that has escaped from the electronics section and wandered into social anthropology.

Converted prices hide this. Work-time comparisons reveal it.

The shift is simple: stop asking what the object costs in dollars and ask how long someone has to work to buy it. Suddenly a phone is not a phone. It is Tuesday, Wednesday and half of Thursday. A burger is not a burger. It is ten minutes in one city and more than an hour in another. The unit has changed from money to life.

That is why work-time indices feel more human than sticker prices. They translate economic conditions into the one budget nobody can print more of.

Reports such as UBS Prices and Earnings have used city-level price and wage comparisons to show how long workers in different places must work to afford the same goods. The method depends on gross or net hourly earnings, annual working hours, tax assumptions and the chosen product price. [S:source-ubs-prices-and-earnings] Secondary summaries have applied similar logic to products such as iPhones. [S:source-wef-iphone-hours]

This sounds clean. It is not.

The first problem is the worker. Which worker? Average wage, median wage, skilled wage, service wage, formal-sector wage, net wage after tax, gross wage before deductions? A phone bought by a software engineer and the same phone bought by a delivery driver do not represent the same burden. One number will always flatten someone.

The second problem is the product. A phone model may be globally recognizable, but prices can include taxes, carrier subsidies, import duties, warranty structures and promotional distortions. A cheap-looking headline can turn expensive once local financing and income are considered. An expensive-looking headline can become ordinary in a high-wage city.

The third problem is the city. City comparisons are seductive because cities feel concrete. Zurich versus Mumbai. New York versus Nairobi. Tokyo versus Mexico City. But cities are not countries, and a central-city wage is not a national life. A comparison can be excellent at showing urban purchasing power and useless as a statement about everyone living under the same flag.

So why use the measure?

Because the alternative is worse. Raw price comparisons are often stupid in a very polished way. A product that costs $900 in two places has not imposed the same burden if one buyer earns $40 an hour and another earns $4. The dollar has done its arithmetic correctly while still failing to explain the situation.

Work-time fixes that failure. Not perfectly, but violently enough to be useful.
...
These measures are funny because they are intimate. They are serious for the same reason. A cost-of-living index is abstract until it tells you that a normal evening out consumes more of your working week than you expected. People understand affordability when it steals time from them.

But work-time comparisons can also flatter the analyst. They look humane, therefore they feel truthful. That is dangerous. The method still needs discipline.

A good work-time comparison states its wage source. It says whether wages are gross or net. It names the product and price source. It avoids pretending that one occupation represents all workers. It does not update a global ranking once and then let the numbers rot for five years while the prose continues wearing them like fresh clothes.

The best version of the measure is not “Country X is rich and Country Y is poor.” That is not insight; that is a headline with a passport. The better version is: the same object enters different lives at different weights.

That idea changes how we read prices.

A latte in one city may be a casual daily indulgence. In another, it is a deliberate expense. A haircut may be cheap in dollar terms and expensive in time terms. A taxi ride may look inexpensive to a visitor and ruinous to a local worker. Rent is the extreme case: it is not merely money paid for shelter, but hours of life transferred to a landlord with suspiciously little ceremony.

The work-time lens also explains why people argue so bitterly about affordability. They are often measuring different realities. One person sees a nominal price. Another sees wages. Another sees rent. Another sees debt. Another sees social expectation. A single object becomes a little courtroom where the whole economy is on trial.

Strange indicators help when they reveal which reality is being discussed. They mislead when they smuggle one reality in as all of them.

The iPhone is a good example because it is absurdly modern and ancient at the same time. Modern because it is a globally distributed slab of electronics. Ancient because the underlying question is old: how much of my labor must I trade for this tool, status symbol, communications device and anxiety rectangle?

That question is more honest than asking whether the phone is “expensive.” Expensive compared to what? Other phones? Last year? Local wages? The buyer’s rent? The amount of time the buyer will spend staring at it instead of living a calmer life?

Work-time indices cannot answer all of that. They answer enough to make the abstraction human.

There is a reason time feels more honest than money.

Money is already an abstraction. It changes costume across borders and classes. One person’s “cheap” is another person’s postponed dental appointment. One household’s normal subscription stack is another household’s weekly food budget. Money pretends to be a common language, but in lived experience it is full of accents.

Time is not perfectly equal either. An hour of pleasant work and an hour of exhausting work are not the same. An hour for a parent juggling childcare is not the same as an hour for someone with no dependents. An hour in a safe job is not the same as an hour in precarious work. But time has a brute quality that money lacks. It reminds us that affordability is not only arithmetic. It is sacrifice.

This is why “hours to buy” comparisons can feel almost rude. They remove the soft cushion around price. A luxury object can no longer hide behind branding if the reader sees it as forty hours of work. A cheap meal can no longer look cheap if it consumes a meaningful slice of local wages. A phone can no longer be discussed as one global product if the work required to buy it changes dramatically by place.

The measure also exposes a strange feature of modern global culture. Advertising globalizes desire faster than wages globalize purchasing power. The same phone launch, the same sneaker, the same streaming show, the same lifestyle image reaches people whose local earning power differs wildly. The object becomes globally familiar before it becomes globally affordable. Work-time comparisons make that gap visible.

That is why the iPhone is such a strong example. It is not merely expensive. It is symbolically synchronized. People around the world know the product at roughly the same time. They see the same camera improvements, the same keynote language, the same smooth videos of aluminum being treated as if it had a spiritual life. But the labor required to buy the object is not synchronized. The marketing is global. The affordability is local.

This is one of the cleanest examples of what strange measures can do. They reveal a mismatch between the story a market tells and the life a buyer inhabits.

A normal price tag tells you what the seller asks.

A work-time price tells you what the buyer surrenders.
...
But the measure can be cruel if used carelessly. It may imply that everyone has access to the wage used in the calculation. It may flatten informal labor, unpaid care, unemployment or underemployment. It may compare an average wage to a product bought disproportionately by people above that wage. It may turn inequality into a single neat number and then congratulate itself for being humane.

The answer is not to abandon the measure. The answer is to write it with manners.

Say whose time. Say which wage. Say which price. Say what the comparison leaves out.

This is not academic fussiness. It is the difference between a useful translation and a misleading one.
...
That sentence should remain underneath the whole chapter, even if the prose never states it so neatly.

Work-time also has a literary advantage: it produces instant inversion.
...
Take a product that appears universal. A phone, a meal, a pair of shoes, a train ticket. The object enters a city wearing the same brand name. Then work-time removes the disguise. For one worker, the object is a casual upgrade. For another, it is a planned sacrifice. For a third, it is simply outside reach. The product is global; the burden is stratified.

This also explains why some consumer debates become emotionally explosive. People are not only arguing about the product. They are arguing about whether the economy recognizes their time. A person told that an object is affordable may hear that their labor is being dismissed. A person told that a city is cheap may hear that local wages have vanished from the conversation.
...
This is where the subject becomes more entertaining and less trustworthy.

Prices made human are still prices. They retain a mathematical spine. Folklore indicators often have something softer: a story that sounds so right people forget to ask whether it is true.

That is how the underwear drawer enters economics.

---

## Chapter 3 — The Folklore of Recession

There is a wonderful kind of economic indicator that sounds plausible for about eleven seconds.

The Lipstick Index is one of them. In hard times, the story goes, people stop buying expensive luxuries but still allow themselves small ones. Not the handbag, but the lipstick. Not the new wardrobe, but the little tube of color that says civilization has not entirely collapsed. It is neat, vivid and just faintly glamorous. It also has the excellent commercial advantage of making recession sound like a department-store problem.

The Men’s Underwear Index is less glamorous, which may be why people remember it even more. The idea is that men replace underwear less often when the economy weakens because nobody sees it and the purchase can be postponed. It is popularly attributed to Alan Greenspan. It has the useful smell of secret central-bank eccentricity: while ordinary people watch GDP, the monetary priesthood studies boxer shorts.

Then come hemlines, skyscrapers and other creatures from the same forest. Skirts allegedly rise and fall with markets. Record-breaking towers supposedly appear at the edge of downturns. Each story has a shape the mind enjoys: private behavior reveals public stress; vanity exposes macroeconomics; architecture confesses hubris before finance does.

The problem is that a good story can outrun its evidence.

The Lipstick Index is best treated as a media-friendly hypothesis, not a dependable recession tool. Leonard Lauder’s early-2000s observation helped popularize the idea, and later writers have revived it whenever cosmetics sales, consumer anxiety and recession talk happen to stand near one another. But subsequent evidence is mixed, and some explanations shift from lipstick to nail polish, mascara or other affordable luxuries depending on the moment. A theory that keeps changing cosmetics bags may still contain insight about consumer psychology, but it is not a stable macroeconomic instrument. [S:source-rbc-lipstick] [S:source-lipstick-secondary]

The Men’s Underwear Index has a similar charm problem. There is limited empirical discussion of whether men’s underwear sales predict economic conditions, and the Greenspan attribution is repeated more confidently than it is usually sourced. The underlying behavior is plausible: hidden replacement purchases can be delayed. But plausible is not the same as measured, and memorable is not the same as true. [S:source-medical-economics-weird]

This distinction matters because folklore indicators do not feel weak. They feel better than ordinary statistics. They feel like hidden knowledge. That is their commercial power. An inflation report is public. An underwear index feels like a trick the serious people forgot to hide.

Economic folklore has three ingredients:

First, it is concrete. Lipstick, underwear, skirts and skyscrapers all make better mental pictures than consumer sentiment surveys.

Second, it is psychologically satisfying. It tells us that people reveal the economy through small involuntary acts. They may deny anxiety, but their shopping carts confess.

Third, it is just hard enough to disprove in casual conversation. Sales can be sliced by category, market, income group, brand, season and cultural moment. One downturn may appear to support the story; another may embarrass it. By the time the evidence has been made precise, the anecdote has already left the room and got itself invited onto a podcast.

The Skyscraper Index belongs to the grander wing of the same building. It suggests a connection between the construction of record-breaking skyscrapers and economic downturns. The symbolic appeal is irresistible. Societies build upward at the moment confidence becomes delusional. Cheap money, credit expansion and civic vanity combine to produce a tower that opens just in time for everyone to discover the lifts are not the only things going down.

This is marvellous prose and dangerous analysis.
...
What are people quietly cutting?

Which small luxuries survive anxiety?

Which visible monuments appear near the top of a cycle?

Where does confidence become performance?

Those are good questions. They become bad answers when turned into prediction machines.

The safest prose around these indicators uses verbs like “suggest,” “reflect,” “hint,” “popularly attributed,” “often repeated,” “contested” and “weakly evidenced.” This is not cowardice. It is respect for the difference between a signal and a story about a signal.

The reader may reasonably ask why we keep these indicators at all. If they are weak, why not throw them out and return to respectable data?

Because they teach the central lesson better than respectable data can. They show how badly we want the economy to reveal itself through ordinary things. They show that the appetite for strange measures is not only analytical. It is emotional. People want an early warning. They want a private clue. They want to believe that a tube of lipstick or a packet of underwear will whisper what official statistics say too late.

That desire is not irrational. Official statistics can lag. Formal models can miss lived experience. But folklore is not automatically better because it is vivid. A myth can travel faster than a spreadsheet and still arrive wrong.

By now the pattern is becoming clearer.

Folklore indicators also reveal something uncomfortable about expertise.
...
The Men’s Underwear Index may be weak as formal economics and still reveal an important class of spending: private, postponable, replacement-based purchases. Many households do not cut spending evenly. They delay what can be delayed. They keep visible obligations and quietly stretch invisible ones. Underwear is funny because it is hidden. The economic idea behind it is not funny at all.

Skyscrapers may fail as prediction machines and still say something about credit, optimism and monument-building. A record tower requires capital, confidence, political permission, design ambition and a long enough boom for everyone involved to believe the sky is available. The problem is not that skyscrapers have no economic meaning. The problem is the leap from meaning to reliable forecast.

This is a recurring pattern in bad index thinking: a measure begins as metaphor, then sneaks into prediction.
...
The survival question is crucial. Weak indicators do not survive only because people are foolish. They survive because they satisfy needs that formal indicators do not. They are portable. They are visual. They let people feel ahead of the official narrative. They turn macroeconomics into gossip, and gossip is one of humanity’s most successful information technologies.
...
The second is diagnostic: those changed purchases can reveal something about consumer mood or constraint. This may be true in context.

The third is predictive: those purchases reliably forecast recessions. This is the dangerous leap.

Many weak indicators survive by sliding between these claims. A writer begins with behavior, moves to diagnosis and ends with prediction. The reader feels continuity because the object remains the same. But the evidentiary burden has changed completely.
...
“This predicts what happens next”?
...
A serious indicator must often explain itself before it can be understood. A folklore indicator arrives pre-explained. Lipstick goes up because people want small luxuries. Underwear sales fall because men delay invisible purchases. Skyscrapers rise because boom-time arrogance wants a monument. Hemlines move because culture and money are supposedly dancing together. The causal story is built into the object.

That built-in story is the advantage. It is also the evidence hazard.
...
Can lipstick introduce the idea of affordable luxuries? Yes.

Can underwear introduce postponable hidden consumption? Yes.

Can skyscrapers introduce boom-time capital intensity and confidence? Yes.

Can any of them carry the claim “this predicts recessions reliably”? Not without much stronger evidence than public retellings usually provide.
...
A folklore index has an object and a story, then hopes nobody asks too many questions about the method.

The next family of measures is different. It is less intimate, less funny and much harder to fit in a shopping bag. It does not come from cosmetics counters or underwear drawers. It comes from oceans, ports, containers, coal, grain, iron ore and electricity.

If lipstick is the economy as anecdote, shipping is the economy with its sleeves rolled up.

---

## Chapter 4 — The Economy Under the Economy

Most consumer indicators begin at the shelf.

Shipping indicators begin before the shelf exists.

Before a shirt becomes fashion, cotton moves. Before a phone becomes desire, components move. Before a loaf of bread becomes breakfast, grain moves. The visible economy is full of packaging, brands, prices and moods. Underneath it sits a less photogenic economy of vessels, containers, ports, fuel, routes, capacity, warehouses, energy and waiting.

It is not cute. That is one reason to trust it slightly more.

The Baltic Dry Index is one of the best-known signals from this deeper layer. It tracks the cost of moving major dry bulk commodities by sea: things like iron ore, coal and grain. Unlike lipstick or underwear, it is not a consumer anecdote masquerading as a secret. It is a market benchmark rooted in physical shipping. The Baltic Exchange describes its bulk freight indices as based on assessments of route fixtures or price points, taking into account previous transactions, market conditions, supply and demand, with vetted shipbrokers submitting route assessments. [S:source-baltic-exchange]

That does not make it magic. It makes it grounded.

Dry bulk shipping is tied to the movement of raw materials. If demand for iron ore, coal or grain transport changes, freight rates can respond. If vessel supply is tight, rates can jump. If trade slows, rates can weaken. The signal is closer to the physical pulse of production than a story about lipstick sales. Ships are expensive, slow-moving assets. You do not conjure new fleets overnight because a spreadsheet feels optimistic.

But even grounded measures have limits.

The Baltic Dry Index is not “the world economy.” It is a slice of the freight market. It reflects dry bulk shipping conditions, not services, software, consumer confidence, local housing or whether anyone can afford a dentist. It can be distorted by vessel supply, route-specific conditions, commodity cycles and shocks that are real but narrow. A grounded signal is still a signal from somewhere.

That “somewhere” is the point. A good index tells you what room it is standing in.

Container freight indices stand in a different room. A container is not dry bulk. It is the metal box that made modern retail feel inevitable. Container rates describe the movement of manufactured goods and components through trade lanes. Freightos Baltic Index data, for example, concerns 40-foot container spot freight rates, using aggregated market data and calculation methods distinct from dry bulk shipping. [S:source-freightos-baltic]
...
The same is true of electricity demand. Electricity is a beautiful signal because it is hard to fake at scale. Factories, homes, data centers, offices, cold storage and railways all need power. Changes in demand can say something about activity, weather, industrial production or crisis. Energy-data organizations and operational maps can make that activity visible. [S:source-ember-energy] [S:source-electricitymaps]

But electricity is not pure GDP in cable form. Weather matters. Efficiency matters. Industry mix matters. Solar generation and grid structure matter. A heatwave can make electricity demand look economically lively because everyone is trying not to melt. A recession can coincide with technological or structural shifts that muddy the picture. Again: useful signal, limited room.

Restaurant reservations are even more delicate. They can reveal consumer behavior quickly. They can also reflect seasonality, local rules, tourism, platform coverage and whether people have decided that paying restaurant wine markups is an act of financial self-harm. As a nowcasting clue, reservations can be interesting. As a grand index of economic truth, they should be kept on a shorter leash.

The physical-economy chapter is important because it restores seriousness after the folklore chapter. It shows that not all strange indicators are equally flimsy. Some are strange only because ordinary readers do not usually stare at freight assessments. A shipping index may sound obscure, but it can be methodologically clearer than a recession theory built out of lipstick.

There is an irony here. The more grounded indicator is often less culturally viral. Everybody can imagine lipstick. Fewer people can imagine a Capesize vessel market without their eyes politely leaving the conversation. The economy rewards vividness in attention, but not always in truth.

This creates a communication problem. The best indicators may need translation before they can reach readers. The Baltic Dry Index tells a stronger story once the reader understands that it is not an abstract financial number floating above the world, but a price connected to moving heavy things across water. Container freight becomes more vivid once the reader sees that the modern shop shelf is a sequence of ports and boxes pretending to be convenience.

The strange measure must make the invisible visible.

That does not mean it must be cute. It means it must be legible.

The physical economy also teaches humility. A freight rate can rise because demand is strong, because vessel supply is constrained, because a route is disrupted, because fuel costs shift, because ports jam, because geopolitics interferes, because the world has once again discovered that “globalization” is a comforting word for a machine made of many breakable parts.

This is why shipping measures are excellent antidotes to lazy abstraction.

Modern consumers are trained to experience logistics as absence. A product is available or it is not. Delivery is tomorrow or late. Shipping is free, which is one of the great retail lies of the age; it means only that the cost has been buried somewhere more convenient. The physical system disappears when it works. It becomes visible only when it fails.

Freight indices make the disappeared system visible before failure reaches the shelf.

They also remind us that not all economic signals are about consumers. A consumer-led view of the economy is natural because most people experience markets as buyers. But before buying comes movement. Raw materials must move. Components must move. Finished goods must move. Energy must flow. Containers must be in the right place, which they frequently are not because the world is inconveniently shaped and human demand lacks symmetry.

This makes physical indicators feel less democratic than burgers but more structural. Not everyone can check a shipbroker assessment. Not everyone follows container trade lanes. But the measures point to systems that consumer anecdotes can miss.

A recession may be felt in lipstick sales after households change behavior. A shipping rate may move when industrial demand or logistical stress changes earlier in the chain. That does not make shipping predictive in a magical sense. It means the signal sits in a different part of the sequence.

Sequence matters. Strange indicators are often discussed as if they compete in one general talent show: which one predicts the economy best? That is the wrong question. A better question is: where in the system does this measure sit?

The Big Mac sits at retail price and currency comparison. Work-time sits between wages and consumption. Lipstick sits in consumer mood and substitution. Shipping sits in physical trade. Electricity sits in production, weather and infrastructure. AI benchmarks sit in technical evaluation and reputation markets.

Each is a window. A window is useful if you know which wall it is in.

The Baltic Dry Index also raises a useful issue about expert assessment. People sometimes imagine that a real index must be purely transaction-based, as if every useful number simply falls out of a machine. In many markets, especially complex physical markets, expert assessment remains part of benchmark production. That does not make the benchmark fake. It means governance, methodology and contributor quality matter. The Baltic Exchange’s description of vetted shipbrokers and representative routes is precisely the kind of institutional machinery a serious reader should look for. [S:source-baltic-exchange]

This is another contrast with folklore. The Men’s Underwear Index may have a clever behavioral story, but the method is often vague in public retellings. A freight benchmark may be less amusing, but it can usually point to a methodology document. Boredom is not proof of quality, but a transparent method is a good sign.

Container indices add the modern supply-chain lesson. The container is a strange object because it is boring by design. Its genius is standardization. It has no romance. It is a metal rectangle that quietly reorganized global trade. As an index object, it is almost the opposite of lipstick. Lipstick is psychologically vivid. The container is operationally decisive.

The reader does not need to become a shipping analyst. They need to understand that the economy contains layers. Some layers speak through prices on shelves. Some through wages. Some through consumer habits. Some through freight and energy. A strange index is useful when it helps the reader locate the layer.

There is also a humility about physical systems that modern digital culture badly needs. Digital products often make scale feel frictionless. A file copies. A service launches. A chart updates. But physical markets remain stubborn. Ships move slowly. Ports jam. Energy grids strain. Droughts happen. Wars close routes. A container in the wrong place is not corrected with a keyboard shortcut.
...
It is tempting to trust a shipping index simply because it sounds hard. Ships are large. Ports are industrial. Freight has the smell of reality. Compared with lipstick, it feels like a grown-up has entered the room wearing steel-toed boots. That instinct is partly fair. Physical-market indicators often have stronger grounding than consumer folklore. But hardness is not the same as completeness.

The Baltic Dry Index can rise for reasons that do not mean broad prosperity. Vessel supply can tighten. Weather and geopolitics can disrupt routes. Commodity-specific demand can shift. Financial speculation and expectations can influence behavior around real capacity. The index is closer to physical reality than a department-store anecdote, but it still needs interpretation.

This is a useful moment to introduce the difference between signal and explanation.

A signal says: something changed.

An explanation says: here is why.

Many bad readings of indices confuse the two. The number moves, and the observer immediately attaches a story. Freight up means demand boom. Freight down means recession. Reservations down means consumer weakness. Electricity up means industry recovery. Sometimes the story is right. Sometimes it is merely available.

The discipline is to let the signal provoke investigation rather than replace it.
...
This is also a good place to introduce the idea that some measures are used by insiders before they become explainable to outsiders. The Big Mac Index is built for public understanding. Freight benchmarks are built for market participants. When public writers borrow them, they must translate in the opposite direction: from expert signal into ordinary explanation.

That translation has its own risk. The writer may over-simplify to make the signal dramatic. They may call BDI a recession predictor because “dry bulk freight route assessment under specific supply-demand conditions” lacks fireworks. The pressure to make expert indicators viral can turn serious measures into folklore. A grounded index can be degraded by bad public use.
...
Different indicators speak at different speeds. Official statistics often arrive after the fact because serious measurement takes time. Consumer behavior can shift quickly but noisily. Freight rates can respond rapidly to market pressure but require expert interpretation. Electricity demand may move minute by minute but needs weather and structural context. Restaurant reservations can appear almost instantly but are limited by platform coverage and behavior.

A strange index is partly a bet on timing.

Does it tell us something before official data does?

Does it tell us something official data cannot?

Or does it merely tell us the same thing with better packaging?
...
One number cannot explain all that. It can point.

This is what separates useful indicators from toy indicators. The useful one invites you to ask the next question. What cargo? Which route? Which vessel class? Which time horizon? Which market structure? What else moved at the same time?

The toy indicator invites you to repeat a clever sentence.
...
So someone turns the air into cigarettes.

This is either brilliant or reckless.
...
Air is difficult to measure emotionally.

You can smell smoke. You can see a brown sky. You can cough. But much of the danger in polluted air is statistical, cumulative and invisible. Fine particulate matter does not arrive with a small invoice explaining its long-term health implications. It enters the body without ceremony. The measurement unit — micrograms per cubic meter — is precise and almost completely useless to ordinary intuition.

So the mind reaches for a translation.

One of the most striking translations is the cigarette-equivalent pollution measure. Instead of telling people that fine particulate matter is at a given concentration, it says roughly: breathing this air is comparable, in risk terms, to smoking some number of cigarettes. Berkeley Earth helped popularize a method for relating PM2.5 exposure to cigarette-equivalent harm. [S:source-berkeley-earth]

The attraction is immediate. Cigarettes are culturally loaded, familiar and bodily. People may not know what a PM2.5 reading means, but they know a cigarette is not a vitamin. The comparison turns invisible risk into an object with ash on it.

This is exactly why it works.

It is also exactly why it can mislead.

A cigarette-equivalent is not a literal chemical equivalence. Polluted air and cigarette smoke are not the same exposure. The analogy is a risk translation, not a statement that the body has received an identical dose of the same substances. The number compresses complex epidemiology, exposure assumptions and health risk into a familiar unit. That compression is powerful because it is memorable. It is dangerous because memorable health analogies tend to harden into literal claims as they travel.

Chapter 5 is not an environmental-health guide. It is a chapter about human-scale measurement. Air pollution matters here because it gives the book one of its clearest examples of abstraction becoming readable. The story is not “air is bad.” The story is: a strange unit can make a hidden risk understandable, and the same act of translation can oversimplify the risk.

That distinction must stay bright.

There are several measures in this area, and they are easy to confuse. PM2.5 concentration is a measurement of fine particulate matter in the air. AQI is an index designed to communicate air quality and health concern. Annual exposure is not the same thing as a short-term spike. A daily average is not the same thing as the worst hour. Different countries can use different AQI methods, and OpenAQ explicitly notes that air quality indices are not standardized globally. [S:source-openaq] AirNow explains the U.S. AQI as a public communication index with categories and health concern levels. [S:source-who-air-quality]
...
Make the measure vivid enough to matter.

Keep it honest enough not to become nonsense.

The best version of the cigarette-equivalent idea says: this is a way to visualize risk. It does not say: this city literally smoked X cigarettes for you today. It does not turn one day’s air into a lifetime diagnosis. It does not pretend that all bodies, locations, durations and pollutants collapse neatly into one tidy stick of tobacco.

There is a family resemblance here with carbon equivalents. A tonne of CO2 is abstract. A flight is familiar. Carbon calculators often translate emissions into flight distances, car miles, household energy or other everyday comparisons. ICAO provides a carbon emissions calculator methodology for flights, and explainers such as Our World in Data discuss transport emissions in CO2-equivalent terms, including assumptions beyond carbon dioxide alone. [S:source-ourworldindata-co2]

Again, useful and limited.

Carbon equivalents help because the climate system is too large for ordinary perception. Nobody feels one kilogram of carbon dioxide leaving an aircraft seat. But people understand a flight. They understand a car journey. They understand a household. The translation gives scale a shape.

Equivalence measures work best when the thing being measured is both important and emotionally unavailable.

Air pollution is like that. Climate emissions are like that. Radiation comparisons, calorie comparisons, water-footprint comparisons and energy equivalents all live in the same neighborhood. The underlying variables may be measurable, but they do not enter everyday intuition naturally. Nobody evolved to feel a microgram per cubic meter. Nobody wakes up with a native sense of atmospheric carbon concentration. The body understands smoke, heat, fatigue and smell; it does not understand a data table.

So the translator reaches for a familiar harm.

This move is powerful because it bypasses explanation. It says: you already know this kind of bad. Now use that feeling to understand this other kind of bad.

The danger is that feelings do not preserve methodology.
...
It explains why strange indices are not just data tricks. They are narrative decisions. The unit decides whether the reader thinks like a shopper, worker, patient, traveler, trader, engineer or citizen. A burger makes the reader a buyer. Work-time makes them a laborer. Cigarettes make them a body. Shipping makes them part of a supply chain. AI benchmarks make them a judge of machine performance.

This is why the final chapter’s checklist must include the question: what unit did the index choose, and what did that choice make me feel?
...
That problem is not unique to pollution. It appears whenever a technical risk must be made public: flood maps, heat indexes, fire danger ratings, pandemic dashboards, radiation exposure comparisons, food-safety scores. The public needs translation. Translation creates compression. Compression creates loss.
...
Shock: the air can be translated into cigarettes.

Explanation: the comparison is based on health-risk relationships around fine particulate exposure.

Limitation: the exposure is not chemically identical to smoking, and air-quality measures are not interchangeable.
...
This does not mean the prose must become solemn. It means the jokes need sharper boundaries. The cigarette comparison is already dramatic. It does not need a comedian standing on top of it. The humor, if any, should come from the human difficulty of understanding invisible risk, not from the risk itself.

There is also an opportunity to show respect for official units. Popular writing often treats technical language as the enemy. But micrograms per cubic meter, AQI categories and exposure windows exist for reasons. They are not bad because they are hard to feel. They are bad only when used alone with audiences who need intuitive scale.
...
This is where strange measures become ethically delicate. A burger comparison can mislead your view of currencies. A cigarette comparison can mislead your sense of health risk. A carbon comparison can mislead your sense of climate impact. The stakes are different.

That does not mean we should abandon vivid measures. It means we should be more demanding of them.

A good risk-equivalence measure needs at least four things:

First, a clear underlying pollutant or risk variable. PM2.5 is not “air” in general. CO2-equivalent is not “environmental harm” in general.

Second, a clear time frame. One hour, one day, one year and one lifetime are different animals.

Third, a clear analogy boundary. The comparison must say what is being compared and what is not.

Fourth, a warning against literalism. The analogy exists to help the reader think, not to replace the underlying science.
...
And once people use a measure for decisions, rewards, rankings, blame or status, the measure is no longer just observing the world.
...
The most dangerous moment in the life of a measure is when people begin caring about it.

That sounds unfair. A measure exists to be used. If nobody cares, it is just a lonely number in a report. But the moment a measure becomes a target, people adapt. They optimize. They polish. They route around it. They learn the rules of the scoreboard and then, with touching human consistency, begin playing the scoreboard rather than the game.

This is the broad lesson associated with Goodhart’s law. In its monetary-policy origins, Charles Goodhart’s point concerned the tendency of statistical regularities to break down when used for control. Later writers popularized the sharper formulation that when a measure becomes a target, it stops being a good measure. [S:claim-goodhart-risk]
...
3. The visible measure becomes valuable.
...
Artificial intelligence did not invent the benchmark problem.

It merely made it faster, louder and more expensive.

The AI world is full of measures: model scores, benchmark suites, leaderboards, capability reports, readiness rankings, safety evaluations, coding tests, math tests, reasoning tests, multimodal tests, agent tests and charts showing lines climbing upward with the calm menace of a species that has discovered PowerPoint. The names are new. The problem is old.

We are trying to measure something too large and slippery to observe directly.
...
Reliability: how often it does it correctly across messy cases.

Usefulness: whether the result matters in the real workflow.
...
Each is useful when kept in its cage.
...
That brings the book to its final task. We have walked through burgers, phones, lipstick, underwear, ships, air, benchmarks and manipulated targets. The question is no longer whether strange indicators are serious. They clearly can be. Nor is it whether they are dangerous. They clearly can be that too.
...
Every good strange indicator has an object or unit that carries the idea. A Big Mac. An hour of work. A lipstick. A container. A cigarette-equivalent. A benchmark score. If the object is vague, the measure is probably vague too. “Confidence,” “innovation,” “quality” and “readiness” can be measured, but only after someone makes a series of choices. Those choices are where the story lives.

Second: what is the source?

A first-party methodology is better than a viral chart. An official guideline is better than a recycled blog post. A serious paper is better than a phrase repeated by people who enjoy sounding interesting. This does not mean only institutions can be right. It means source quality matters most when the claim is most memorable.

Third: what is the method?

How is the number produced? Is it a price observation, a survey, a model, an expert assessment, a scraped dataset, a benchmark harness, a ranking formula or a journalist’s clever comparison? The method does not need to be perfect. It needs to be visible enough to criticize.

Fourth: what is the scope?
...
This is the Goodhart question. If the measure becomes important, who can game it? Who can polish it? Who can redefine it? Who benefits? A benchmark attached to money, status or policy is never just a passive description. It becomes part of the system it measures.

Seventh: what would prove it wrong?
...
Do not confuse official with complete.

Do not confuse measured with important.

Do not confuse ranked with understood.
...
The second is suspicion: what exactly disappeared in the translation?
...
- `source-numbeo-cost-of-living`: Cost-of-living price database, used only for context-sensitive lifestyle examples.
- `source-rbc-lipstick` and `source-lipstick-secondary`: secondary lipstick-index explainers, used with contested/folklore treatment.
- `source-medical-economics-weird`: weird-indicator overview, used for Men’s Underwear and Hemline folklore only.
...
- `AirNow AQI Basics`: U.S. AQI communication explanation: https://www.airnow.gov/aqi/aqi-basics
- `source-ourworldindata-co2`: Our World in Data CO2 / transport-emissions explainers, used for CO2-equivalent discussion.
- `ICAO ICEC`: flight-emissions calculator methodology, used for flight-equivalence caveats.
- `claim-goodhart-risk`: Goodhart target/measure principle, supported by Goodhart monetary-management references and later generalized usage.
- `source-libor-case`: U.S. DOJ LIBOR manipulation case: https://www.justice.gov/archives/opa/pr/two-former-deutsche-bank-traders-convicted-role-scheme-manipulate-critical-global-benchmark
- `source-doing-business-report`: World Bank Doing Business discontinuation statement: https://www.worldbank.org/en/news/statement/2021/09/16/world-bank-group-to-discontinue-doing-business-report
